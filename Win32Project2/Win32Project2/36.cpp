...
int main()
{
	...
	//分块设置
	int sizeOfQuadsColumn = 10;
	int sizeOfQuadsRow = 10;
	...
	theNetWork->getTriangleSetOfEachQuadFromDataSet(vector3Set);
	//重组带Z值的三角形集合
	rasterVec3Set imageSet = theNetWork->getPt3SetFromDataSetAndPt2Vector(vector3Set, imagePointVector2Set);
	
	//创建网格文件
	const char * pszRasterFile = "E:\\PCLOutPut20000_Quad10x10.tif";
	int bandSize = 1;
