...
int main()
{
	...
	*/
	...
	{
		int firstID = correspondences->at(i).index_match;
		int secondID = correspondences->at(i).index_query;
		...
		fprintf(fp_correspondences, "(<%d,%d>,%f,%f,{<%f,%f,%f>,<%f,%f,%f>})", 
			firstID, secondID,correspondences->at(i).distance, weight,
			pointX1, pointY1, pointZ1, pointX2, pointY2, pointZ2);
