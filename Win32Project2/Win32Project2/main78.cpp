...
int main()
{
	...
	std::string strInputFileName2 = "E:\\xyz.pcd";
	...
	//近邻个数
	int numberOfNearestNeighbor = 25;
	//法线估计kdtree寻找半径
	...
	{
		fprintf(fp_cloud_PFH1, " <%f>, ", cloud_PFH1->at(i).descriptorSize );
	}
	...
	fp_cloud_normals2 = fopen("E:\\test\\fp_cloud_normals1.txt", "w");
	...
	{
		fprintf(fp_cloud_PFH2, " <%f>, ", cloud_PFH2->at(i).descriptorSize);
	}
	...
	{
		fprintf(fp_correspondences,"%f", correspondences->at(i).distance);
	}
	...
	{
		fprintf(fp_cor_inliners_ptr, "%f", cor_inliners_ptr->at(i).distance);
	}
