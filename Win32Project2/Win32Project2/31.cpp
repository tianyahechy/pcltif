...
Pt2 thePt(438302.593750, 2558206.250000);
Pt3 p1(438302.500000, 2558206.250000, 7.700000);
Pt3 p2(438302.406250, 2558205.500000, 6.100000);
Pt3 p3(438302.593750, 2558206.250000, 6.600000);
std::vector<Pt3> triangleVector;
triangleVector.clear();
triangleVector.push_back(p1);
triangleVector.push_back(p2);
triangleVector.push_back(p3);
