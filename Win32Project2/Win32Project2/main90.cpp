...
int main()
{
	...
	*/
	...
	//sift进行过滤下
	pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_siftGridOutput1 = getSampleCloudByVotex(cloud_siftOutput1, leafSize);
	std::string strcloud_siftGridOutput1 = "E:\\test\\cloud_siftGridOutput1.pcd";
	pcl::io::savePCDFile(strcloud_siftGridOutput1, *cloud_siftGridOutput1);
	//pfh特征描述子提取
	...
	*/
	...
	//sift进行过滤下
	pcl::PointCloud<pcl::PointXYZ>::Ptr cloud_siftGridOutput2 = getSampleCloudByVotex(cloud_siftOutput2, leafSize);
	std::string strcloud_siftGridOutput2 = "E:\\test\\cloud_siftGridOutput2.pcd";
	pcl::io::savePCDFile(strcloud_siftGridOutput2, *cloud_siftGridOutput2);
	...
	trans_east.estimateRigidTransformation(*cloud_siftGridOutput1, *cloud_siftGridOutput2, transformation_matrix);
